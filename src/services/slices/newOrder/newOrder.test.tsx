...
describe('createOrder slice', () => {
  ...
  describe('initial state', () => {
    test('should return initial state with null order data and no request', () => {
  ...
  describe('createOrder pending', () => {
    test('should set orderRequest to true and clear error', () => {
      //создание действия
  ...
  describe('createOrder fulfilled', () => {
    test('should set order data and complete request', () => {
      //создание действия
  ...
  describe('createOrder rejected', () => {
    test('should set error message and keep request state false', () => {
      //создание действия
  ...
  describe('createOrder selectors', () => {
    ...
    test('getOrderRequest should return request status', () => {
      const result = createOrderSlice.selectors.getOrderRequest(testState);
      expect(result).toBe(true);
    });

    //на возврат данных заказа
    test('getOrderModalData should return order data', () => {
