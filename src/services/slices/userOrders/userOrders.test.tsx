...
describe('user orders slice', () => {
  ...
  describe('initial state', () => {
    test('should return initial state with empty orders and loading false', () => {
  ...
  describe('pending actions', () => {
    test('should set loading state to true for any pending action', () => {
  ...
  describe('fulfilled actions', () => {
    test('should set orders data and complete loading for getUserOrders', () => {
    ...
    test('should set orders data and complete loading for getUserOrderByNumber', () => {
      //создание действия
  ...
  describe('rejected actions', () => {
    test('should complete loading and keep orders unchanged for any rejected action', () => {
      const actions = [
  ...
  describe('user orders selectors', () => {
    ...
    test('userOrdersList should return orders list', () => {
    ...
    test('userOrdersByNumber should return orders list', () => {
