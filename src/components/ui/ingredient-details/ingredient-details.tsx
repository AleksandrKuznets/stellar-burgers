...
type IngredientDetailsWithHeaderProps = IngredientDetailsUIProps & {
  showHeader: boolean;
};

export const IngredientDetailsUI: FC<IngredientDetailsWithHeaderProps> = memo(
  ({ ingredientData, showHeader = true }) => {
    ...
    return (
      <div className={styles.wrap}>
        {showHeader && (
          <span className={`text text_type_main-large pt-10 ${styles.header}`}>
            Детали ингредиента
          </span>
        )}
