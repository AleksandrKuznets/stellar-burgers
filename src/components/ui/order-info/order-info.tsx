...
type TOrderInfoUIWithShowHeader = OrderInfoUIProps & { showHeader: boolean };

export const OrderInfoUI: FC<TOrderInfoUIWithShowHeader> = memo(
  ({ orderInfo, showHeader }) => (
    <div className={styles.wrap}>
      {showHeader && (
        <span
          className={`text text_type_digits-default pt-10 ${styles.number}`}
        >
